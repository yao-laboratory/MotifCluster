...
def score(input_file_0, input_file_score_1, input_file_score_2, debug):
    ...
    #new
    data_weight_cluster = []
    for i in range(len(ori_data_axis)):
        data_weight_cluster.append(ori_data_weight[i]) 
    data_weight_cluster.sort()
    #new end
    ...
    # write_weight_result(res_path2, data_weight_cluster, 1)
    # # print(p_score_final)
