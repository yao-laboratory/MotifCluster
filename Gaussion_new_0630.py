...
while(i0 < int(len(data_axis))):
    if (data_axis[i0] - 8) >= 96049000 and (data_axis[i0] + 8 + 1) <= 96050000:
        label_space.append(i0)
    if (data_axis[i0] + 8 + 1) > 96050000:
        break
    i0 += 1
# while(i0 < int(len(label_values)/1000)):
#     if (data_axis[label_values[i0]] - 8) >= 0 and (data_axis[label_values[i0]] + 8 + 1) <= 110270000:
#         print("************************")
#         print(i0)
#         print(label_values[i0])
#         label_space.append(i0)
#         # print("************************")
#         # print(i0)
#     if (data_axis[label_values[i0]] + 8 + 1) > 110270000:
#         break;
#     i0 += 1
...
for i in range(len(p_score_final)):
    if x1[data_count_sum[p_score_final[i][0]]-1] > 6710000 and x1[data_count_sum[p_score_final[i][0]]-1]< 6724000:
        print("rank")
        print(i)
        print(x1[data_count_sum[p_score_final[i][0]]-1])
