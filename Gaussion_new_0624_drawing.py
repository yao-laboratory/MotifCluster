...
for i in range(0, len(gm.means_)):
    ...
    while(i0 < len(label_values)):
        if (data_axis[label_values[i0]] - 8) >= 110261000 and (data_axis[label_values[i0]] + 8 + 1) <= 110269000:
            # print("************************")
            # print(i0)
            # print(label_values[i0])
            label_space.append(i0)
            # # label_space.append(i0+1)
            # print("************************")
            # print(i0)
        if (data_axis[label_values[i0]] + 8 + 1) > 110269000:
            break;
        i0 += 1
...
for i in range(len(data_axis)):
    if data_axis[i] >= 110261000 and data_axis[i] <= 110269000:
